    ...
    for z in range(zoom_start, 13):
        for x in range(x_low_map[z], x_high_map[z] + 1):
            for y in range(y_low_map[z], y_high_map[z] + 1):
                ...
                directory = '/Users/richardtang/Desktop/repos/ritcher-map-v2/apps/ui/public/tiles/black-myth-wukong/{region}/{z}/{x}'.format(region=region,z=z, x=x)
