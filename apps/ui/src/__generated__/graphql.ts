...
export type FetchGameByRegionQuery = { __typename?: 'Query', fetchGameByRegion: { __typename?: 'Game', title: string, slug: string, groups?: Array<{ __typename?: 'MarkerGroup', title: string, categories?: Array<{ __typename?: 'MarkerCategory', icon: string, info?: string | null, title: string }> | null }> | null, regions?: Array<{ __typename?: 'Region', slug: string, maxZoom: number, minZoom: number, order: number, tilePath: string, title: string, zoom: number, locations?: Array<{ __typename?: 'MarkerLocation', description?: string | null, title: string }> | null }> | null } };
