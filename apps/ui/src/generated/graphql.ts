  ...
  checklist: {
    ...
    categories?: Array<{
      ...
      locations?: Array<{
        ...
        longitude: number;
        mapSlug: string;
        map: { __typename?: "Map"; slug: string };
...
export type MapDetailsQuery = {
  __typename?: "Query";
  mapDetails: { __typename?: "Map"; gameSlug: string; title: string };
};
...
export type GetGamesQuery = {
  __typename?: "Query";
  game: { __typename?: "Game"; slug: string; title: string };
};
...
export type GamesQuery = {
  __typename?: "Query";
  games: Array<{ __typename?: "Game"; slug: string; title: string }>;
};
...
export type FetchGameByMapQuery = {
  __typename?: "Query";
  game: {
    __typename?: "Game";
    title: string;
...
export type AddFoundLocationMutation = {
  __typename?: "Mutation";
  addFoundLocation: {
    __typename?: "User";
    email: string;
...
export type RemoveFoundLocationMutation = {
  __typename?: "Mutation";
  removeFoundLocation: {
    __typename?: "User";
    email: string;
...
export type ToggleHideFoundSettingMutation = {
  __typename?: "Mutation";
...
export type MapDataQuery = {
  ...
  mapData: {
    ...
    locations?: Array<{
      ...
      media?: Array<{ __typename?: "Media"; url: string; type: string }> | null;
    }> | null;
    regions?: Array<{
      __typename?: "Region";
      centerX?: number | null;
    ...
    game?: {
      __typename?: "Game";
      slug: string;
      maps?: Array<{ __typename?: "Map"; title: string; slug: string }> | null;
      groups?: Array<{
        __typename?: "Group";
        id: number;
        title: string;
...
export type AddNoteMarkerMutation = {
  __typename?: "Mutation";
  addNoteMarker: {
    __typename?: "NoteMarker";
    id: number;
...
export type RemoveNoteMarkerMutation = {
  __typename?: "Mutation";
  removeNoteMarker: {
    __typename?: "User";
    noteMarkers?: Array<{
...
export type UpdateNoteMarkerMutation = {
  __typename?: "Mutation";
  updateNoteMarker: {
    __typename?: "NoteMarker";
    id: number;
...
export function getSdk(
  ...
  return {
    ...
    ): Promise<ChecklistQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ChecklistQuery>(ChecklistDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "Checklist",
    ...
    MapDetails(
      ...
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<MapDetailsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<MapDetailsQuery>(MapDetailsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "MapDetails",
    ...
    GetGames(
      ...
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetGamesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetGamesQuery>(GetGamesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetGames",
    ...
    Checklists(
      ...
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<ChecklistsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ChecklistsQuery>(ChecklistsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "Checklists",
    ...
    Games(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GamesQuery>(GamesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "Games",
    ...
    FetchGameByMap(
      ...
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<FetchGameByMapQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<FetchGameByMapQuery>(
            FetchGameByMapDocument,
            variables,
    ...
    AddFoundLocation(
      variables: AddFoundLocationMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<AddFoundLocationMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddFoundLocationMutation>(
            AddFoundLocationDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "AddFoundLocation",
    ...
    RemoveFoundLocation(
      variables: RemoveFoundLocationMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<RemoveFoundLocationMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RemoveFoundLocationMutation>(
            RemoveFoundLocationDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "RemoveFoundLocation",
    ...
    ToggleHideFoundSetting(
      variables: ToggleHideFoundSettingMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<ToggleHideFoundSettingMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ToggleHideFoundSettingMutation>(
            ToggleHideFoundSettingDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "ToggleHideFoundSetting",
    ...
    MapData(
      ...
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<MapDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<MapDataQuery>(MapDataDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "MapData",
    ...
    AddNoteMarker(
      variables: AddNoteMarkerMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<AddNoteMarkerMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddNoteMarkerMutation>(
            AddNoteMarkerDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "AddNoteMarker",
    ...
    RemoveNoteMarker(
      variables: RemoveNoteMarkerMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<RemoveNoteMarkerMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RemoveNoteMarkerMutation>(
            RemoveNoteMarkerDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "RemoveNoteMarker",
    ...
    UpdateNoteMarker(
      variables: UpdateNoteMarkerMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<UpdateNoteMarkerMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateNoteMarkerMutation>(
            UpdateNoteMarkerDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "UpdateNoteMarker",
